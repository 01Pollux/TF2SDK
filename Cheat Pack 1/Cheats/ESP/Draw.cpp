...
bool GlobalESP::GetBoxInfo(const TF2::IBaseEntity pEnt, ESPInfo::BoxInfo& boxinfo)
{
	...
	const Vector3D_F mins = (is_zero ? Vector3D_F{ -12.5f, -12.5f - 12.5f } : pEnt->Mins) + origin;
	const Vector3D_F maxs = (is_zero ? Vector3D_F{ 12.5f, 12.5f, 12.5f } : pEnt->Maxs) + origin;
